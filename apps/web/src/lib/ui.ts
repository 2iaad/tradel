...
export const cardCls = 'bg-sidebar border border-border-subtle rounded-[10px]';
...
export const cardFooterCls = 'border-t border-border-faint bg-muted/35 px-[22px] py-3';
