...
export function buildDemoNotes(trades: ApiTrade[]): ApiNote[] {
    const noteSeeds = [
        {
            trade: 0,
            title: 'Waited for the opening range',
            body: 'Took the breakout only after the retest held. Good patience and clean invalidation.',
            tags: ['BREAKOUT', 'DISCIPLINE'],
        },
        {
            trade: 2,
            title: 'Daily support reclaim',
            body: 'Strong relative strength after the first pullback. Entry was planned; exit followed the target.',
            tags: ['REVERSAL', 'A-SETUP'],
        },
        {
            trade: 5,
            title: 'Trend continuation',
            body: 'Momentum stayed intact above VWAP. Sized normally and avoided adding into extension.',
            tags: ['MOMENTUM', 'RISK'],
        },
        {
            trade: 9,
            title: 'Entered before confirmation',
            body: 'The short thesis was reasonable, but the trigger was early. Wait for structure to break next time.',
            tags: ['REVIEW', 'PATIENCE'],
        },
        {
            trade: 12,
            title: 'Clean rejection at resistance',
            body: 'Price rejected the level twice and order flow confirmed the short. Managed without interference.',
            tags: ['A-SETUP', 'DISCIPLINE'],
        },
        {
            trade: 20,
            title: 'Best execution this month',
            body: 'Clear pre-market level, defined risk, and no emotional management after entry.',
            tags: ['BREAKOUT', 'PROCESS'],
        },
    ];
